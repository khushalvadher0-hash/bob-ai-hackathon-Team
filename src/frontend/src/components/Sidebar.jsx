...
export default function Sidebar() {
  const navItems = [
    ...
    { to: '/operations', label: '72-Hour Operations', icon: CalendarClock },
  ];
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.7rem', color: 'var(--text-secondary)' }}>Congestion & Planning</p>
        </div>
      </div>
      ...
      <div style={{ padding: '16px 24px', borderTop: '1px solid var(--border-color)', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
          ...
          <span style={{ color: 'var(--text-secondary)', fontWeight: 600 }}>Port Network Online</span>
        </div>
